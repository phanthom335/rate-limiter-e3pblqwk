    """
    Rate Limiter E3pblqwk
    =====================
    Minimal HTTP service that acts as a aggregate layer for existing third-party APIs.
    ...
    APP_NAME    = "Rate Limiter E3pblqwk"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Minimal HTTP service that acts as a aggregate layer for existing third-party APIs.")
